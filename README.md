...
* [Asynchronous GPS driver](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/GPS.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Receive and parse GPS data as a uasyncio task.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 688 | 🐛 22 | 🌐 Python | 📅 2026-03-14 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,846 | 🐛 230 | 🌐 Python | 📅 2026-08-17 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,846 | 🐛 230 | 🌐 Python | 📅 2026-08-17 - Official driver for nRF24L01 2.4GHz radio modules.
...
* [I2C Slave](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/I2C.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Uses the Pyboard's I2C slave mode to implement a full duplex asynchronous link. Principal use case is for ESP8266 which has only one UART.
...
* [microdot](https://github.com/miguelgrinberg/microdot) ⭐ 2,139 | 🐛 7 | 🌐 Python | 📅 2026-08-09 - The impossibly small web framework for MicroPython.
...
* [micropython-waveshare-epaper](https://github.com/mcauser/micropython-waveshare-epaper) ⭐ 394 | 🐛 22 | 🌐 Python | 📅 2021-09-01 - Drivers for various Waveshare ePaper modules.
...
* [lvgl](https://github.com/lvgl/lv_binding_micropython) ⭐ 353 | 🐛 70 | 🌐 C | 📅 2026-06-30 - An object-oriented, component-based high-level GUI library with MicroPython binding.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,846 | 🐛 230 | 🌐 Python | 📅 2026-08-17 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,846 | 🐛 230 | 🌐 Python | 📅 2026-08-17 - Driver for SSD1306 128x64 OLED displays.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,846 | 🐛 230 | 🌐 Python | 📅 2026-08-17 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
...
* [Schedule](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/SCHEDULE.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - A scheduler for asyncio based applications. Schedule events at specified times and dates or with reference to Sun and Moon rise and set.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,035 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [MicroPython on GitHub](https://github.com/micropython/micropython) ⭐ 22,009 | 🐛 1,539 | 🌐 C | 📅 2026-08-18 - Submit bug reports, follow and join in development on GitHub.
* [MicroPython Wiki](https://github.com/micropython/micropython/wiki) ⭐ 22,009 | 🐛 1,539 | 🌐 C | 📅 2026-08-18 - Community generated documentation and examples of the features of MicroPython and the Pyboard.
...
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 315 | 🐛 24 | 🌐 Python | 📅 2026-08-20 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
...
* [mpremote](https://github.com/micropython/micropython/blob/master/tools/mpremote/README.md) ⭐ 22,009 | 🐛 1,539 | 🌐 C | 📅 2026-08-18 - Powerful official shell that supports mounting the host's current directory on the target. Run code without changing the target's filesystem.
