# Awesome micropython with stars
...
* [MicroMLP](https://github.com/jczic/MicroMLP) ⭐ 195 | 🐛 6 | 🌐 Python | 📅 2020-12-23 - A micro neural network multilayer perceptron for MicroPython (used on ESP32 and Pycom modules).
* [emlearn-micropython](https://github.com/emlearn/emlearn-micropython) ⭐ 164 | 🐛 11 | 🌐 C | 📅 2026-07-30 - Efficient Machine Learning engine for MicroPython.
* [upython-chat-gpt](https://github.com/karlsoderby/upython-chat-gpt) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2023-06-05 - ChatGPT for MicroPython.
* [mp\_esp\_dl\_models](https://github.com/cnadler86/mp_esp_dl_models) ⭐ 16 | 🐛 2 | 🌐 C++ | 📅 2025-09-10 - MicroPython binding for the ESP DL vision models like face detection.
...
* [yx5300](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/yx5300.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MP3 player that can be controlled via a serial interface.
* [IoTy vs1003](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vs1003.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - Driver for the VS1003 MP3 decoder / encoder. Supports playing of MP3, WMA, MIDI, ADPCM, and recording of ADPCM.
...
* [micropython-telegram-bot](https://github.com/antirez/micropython-telegram-bot) ⭐ 64 | 🐛 1 | 🌐 Python | 📅 2024-10-19 - MicroPython telegram bot library: simple way to put your IoT projects on the cloud.
...
* [PyBoard-HC05-Android](https://github.com/KipCrossing/PyBoard-HC05-Android) ⭐ 12 | 🐛 0 | 🌐 Java | 📅 2020-05-09 - Pyboard HC05 Bluetooth adapter example application.
* [micropython-aioble-itag](https://github.com/mcauser/micropython-aioble-itag) ⭐ 10 | 🐛 0 | 📅 2024-01-14 - Examples using aioble to interact with iTag BLE keychain tags.
* [micropython\_aioble\_examples](https://github.com/ekspla/micropython_aioble_examples) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-06-10 - A few aioble (asyncio BLE) examples of MicroPython using ESP32.
...
* [micropython-mcp2515](https://github.com/jxltom/micropython-mcp2515) ⭐ 34 | 🐛 5 | 🌐 Python | 📅 2023-04-13 - MicroPython MCP2515 driver, porting from Arduino MCP2515 CAN interface library.
* [Robomaster-Micropython](https://github.com/JohnieBraaf/Robomaster-Micropython) ⭐ 31 | 🐛 2 | 🌐 Python | 📅 2020-11-22 - Robomaster S1 - MicroPython CAN BUS controller.
* [microPython\_MCP2515](https://github.com/capella-ben/microPython_MCP2515) ⭐ 6 | 🐛 1 | 🌐 Python | 📅 2023-11-29 - A MicroPython library for the MCP2515 CAN bus controller.
...
* [embit](https://github.com/diybitcoinhardware/embit) ⭐ 115 | 🐛 64 | 🌐 Python | 📅 2026-08-09 - A minimal Bitcoin library for MicroPython and Python 3 with a focus on embedded systems.
...
* [ucryptography](https://github.com/dmazzella/ucryptography) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-08-14 - Lightweight porting of pyca/cryptography to MicroPython based on ARM Mbed TLS.
...
* [mp\_espnow\_wrapper](https://github.com/cnadler86/mp_espnow_wrapper) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-05-29 - Send and receive data between ESPs over ESP-NOW without worries.
...
* [micropython-ftplib](https://github.com/SpotlightKid/micropython-ftplib) ⭐ 41 | 🐛 1 | 🌐 Python | 📅 2025-05-03 - An FTP client library for MicroPython.
* [MicroFTPServer](https://github.com/cpopp/MicroFTPServer) ⭐ 36 | 🐛 1 | 🌐 Python | 📅 2016-10-30 - Minimal FTP Server that can run on an ESP8266 with MicroPython.
...
* [Asynchronous GPS driver](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/GPS.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Receive and parse GPS data as a uasyncio task.
* [micropyGPS](https://github.com/inmcm/micropyGPS) ⭐ 389 | 🐛 15 | 🌐 Python | 📅 2023-02-18 - Full featured GPS NMEA sentence parser.
...
* [micropython-upyphone](https://github.com/jeffmer/micropython-upyphone) ⭐ 425 | 🐛 0 | 🌐 Python | 📅 2017-11-24 - A GSM phone using Pyboard and SIM800l.
* [sim800](https://github.com/basanovase/sim800) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2025-12-08 - Library for interfacing with SIM800 module in MicroPython.
...
* [MicroPython-AM7020](https://github.com/JiekangHuang/MicroPython-AM7020) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2021-03-29 - MicroPython driver for AM7020 Narrowband Internet of Things (NBIoT) module.
...
* [uht](https://github.com/nmattia/uht) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2026-02-15 - Lightweight HTTP server for MicroPython (serve websites and handle requests).

#### IoT

* [micropython-iot](https://github.com/peterhinch/micropython-iot) ⭐ 97 | 🐛 1 | 🌐 Python | 📅 2020-09-20 - An approach to designing IoT applications using ESP8266, ESP32 or Pyboard D endpoints.
...
* [micropython-ha-mqtt-device](https://github.com/agners/micropython-ha-mqtt-device) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2020-05-08 - MicroPython module which allows creating Entites for HomeAssistant using MQTT Discovery.
* [aiomqttc](https://github.com/Tangerino/aiomqttc) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2025-05-21 - Asynchronous MQTT Client for MicroPython AND CPython.
...
* [sensor-mqtt-homeassistant](https://github.com/DougWilkinson/sensor-mqtt-homeassistant) ⭐ 15 | 🐛 1 | 🌐 Python | 📅 2022-07-01 - An ESP8266/ESP32 MicroPython-based sensor platform for GPIO, DHT, analog, LED and more. Includes remote updates for .py code from web server and MQTT/Home Assistant integration.
...
* [micropython-ys-irtm](https://github.com/mcauser/micropython-ys-irtm) ⭐ 35 | 🐛 0 | 📅 2019-12-20 - MicroPython examples for YS-IRTM 5V NEC Infrared UART transceivers.
...
* [EByte\_LoRa\_E220\_micropython\_library](https://github.com/xreef/EByte_LoRa_E220_micropython_library) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2025-01-29 - MicroPython LoRa EBYTE E220 devices.
...
* [EByte\_LoRa\_E22\_micropython\_library](https://github.com/xreef/EByte_LoRa_E22_micropython_library) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2025-02-23 - MicroPython LoRa EBYTE E22 devices.
* [EByte\_LoRa\_E32\_micropython\_library](https://github.com/xreef/EByte_LoRa_E32_micropython_library) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2023-12-12 - MicroPython LoRa EBYTE E32 devices.
...
* [uPyLoRaWAN](https://github.com/lemariva/uPyLoRaWAN) ⭐ 241 | 🐛 12 | 🌐 Python | 📅 2023-12-26 - ESP32 using MicroPython meets LoRa and LoRaWAN.
* [micropySX126X](https://github.com/ehong-tl/micropySX126X) ⭐ 168 | 🐛 15 | 🌐 Python | 📅 2025-12-07 - Semtech SX126X LoRa driver for MicroPython and CircuitPython.
* [SX127x\_driver\_for\_MicroPython\_on\_ESP8266](https://github.com/Wei1234c/SX127x_driver_for_MicroPython_on_ESP8266) ⭐ 156 | 🐛 1 | 🌐 Python | 📅 2025-06-10 - SX127x (LoRa transceiver) driver for (Micro)Python on ESP8266/ESP32/Raspberry Pi.
* [u-lora](https://github.com/martynwheeler/u-lora) ⭐ 95 | 🐛 15 | 🌐 Python | 📅 2023-10-05 - Raspi-lora for MicroPython.
...
* [micropython-mdns](https://github.com/cbrand/micropython-mdns) ⭐ 84 | 🐛 1 | 🌐 Python | 📅 2025-12-29 - A pure Python implementation of MDNS with support for Service Discovery.

#### Modbus

* [micropython-modbus](https://github.com/brainelectronics/micropython-modbus) ⭐ 146 | 🐛 28 | 🌐 Python | 📅 2024-07-01 - ModBus TCP and RTU library supporting client and host mode. Based on pycom-modbus from Pycom.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 688 | 🐛 22 | 🌐 Python | 📅 2026-08-26 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
...
* [NFC\_PN532\_SPI](https://github.com/Carglglz/NFC_PN532_SPI) ⭐ 48 | 🐛 5 | 🌐 Python | 📅 2023-07-17 - Partial port of Adafruit CircuitPython to MicroPython of PN532 NFC/RFID control library (SPI).
* [micropython-nfc](https://github.com/rolandvs/micropython-nfc) ⭐ 14 | 🐛 1 | 🌐 Python | 📅 2026-01-12 - Using NFC with MicroPython.
...
* [micropython-ntp](https://github.com/ekondayan/micropython-ntp) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2025-05-25 - Robust NTP library for MicroPython.
...
* [esp8266\_ntp\_webserver](https://github.com/Roterfux/esp8266_ntp_webserver) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-04-16 - MicroPython + ESP8266 + NTP + web server.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,848 | 🐛 230 | 🌐 Python | 📅 2026-08-24 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [micropython-ota-updater](https://github.com/rdehuyss/micropython-ota-updater) ⭐ 379 | 🐛 9 | 🌐 Python | 📅 2022-03-09 - OTA Updater for MicroPython.
* [senko](https://github.com/RangerDigital/senko) ⭐ 104 | 🐛 5 | 🌐 Python | 📅 2024-02-23 - Simplest OTA update solution for your MicroPython projects.
...
* [uProxy](https://github.com/shawwwn/uProxy) ⭐ 7 | 🐛 1 | 🌐 Python | 📅 2024-01-16 - An asyncio-based, memory-efficient HTTP/HTTPS/SOCKS4/SOCKS5 forward proxy server for MicroPython, compatible with CPython.

#### Radio

* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,848 | 🐛 230 | 🌐 Python | 📅 2026-08-24 - Official driver for nRF24L01 2.4GHz radio modules.
...
* [FBConsole](https://github.com/boochow/FBConsole) ⭐ 65 | 🐛 1 | 🌐 Python | 📅 2019-10-12 - Framebuffer console class for MicroPython.
...
* [micropython-mfrc522](https://github.com/wendlers/micropython-mfrc522) ⭐ 188 | 🐛 21 | 🌐 Python | 📅 2024-01-18 - Driver for NXP MFRC522 RFID reader/writer.
...
* [micropython-ds1302-rtc](https://github.com/omarbenhamid/micropython-ds1302-rtc) ⭐ 55 | 🐛 2 | 🌐 Python | 📅 2021-07-12 - DS1302 RTC Clock driver for MicroPython.
...
* [micropython-ds1302-rtc](https://github.com/PaszaVonPomiot/micropython-ds1302-rtc) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-04-27 - DS1302 RTC Clock driver for MicroPython.
...
* [I2C Slave](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/I2C.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Uses the Pyboard's I2C slave mode to implement a full duplex asynchronous link. Principal use case is for ESP8266 which has only one UART.
...
* [minipb](https://github.com/dogtopus/minipb) ⭐ 64 | 🐛 6 | 🌐 Python | 📅 2023-03-28 - Mini Protobuf {de}serializer in pure Python.
* [micropython-msgpack](https://github.com/peterhinch/micropython-msgpack) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-05-25 - MessagePack serialisation library optimised for MicroPython.
...
* [XAsyncSockets](https://github.com/jczic/XAsyncSockets) ⭐ 42 | 🐛 3 | 🌐 Python | 📅 2024-04-02 - XAsyncSockets is an efficient Python/MicroPython library of managed asynchronous sockets.
...
* [micropython-samtts](https://github.com/jacklinquan/micropython-samtts) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2025-04-20 - A MicroPython port of Software Automatic Mouth Text-To-Speech program.
...
* [microdot](https://github.com/miguelgrinberg/microdot) ⭐ 2,142 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - The impossibly small web framework for MicroPython.
* [MicroWebSrv2](https://github.com/jczic/MicroWebSrv2) ⭐ 719 | 🐛 55 | 🌐 Python | 📅 2025-08-18 - The last micro web server for IoTs (MicroPython) or large servers (CPython), that supports WebSocket, routes, template engine and with really optimized architecture (mem allocations, async I/Os).
...
* [WiFiManager](https://github.com/tayfunulu/WiFiManager) ⭐ 415 | 🐛 28 | 🌐 Python | 📅 2025-08-08 - WiFi manager for ESP8266 - ESP12 - ESP32 - MicroPython.
* [micropython-wifimanager](https://github.com/mitchins/micropython-wifimanager) ⭐ 73 | 🐛 0 | 🌐 Python | 📅 2026-06-08 - A simple network configuration utility for MicroPython on the ESP8266 board.
* [micropython-wifi\_manager](https://github.com/ferreira-igor/micropython-wifi_manager) ⭐ 68 | 🐛 6 | 🌐 Python | 📅 2023-10-09 - WiFi Manager for ESP8266 and ESP32 using MicroPython.
* [Micropython-ESP-WiFi-Manager](https://github.com/brainelectronics/Micropython-ESP-WiFi-Manager) ⭐ 38 | 🐛 7 | 🌐 Python | 📅 2023-06-16 - WiFi Manager to configure and connect to networks.
...
* [enigmapython](https://github.com/denismaggior8/micropython-enigma-python) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-07-31 - A simple yet faithful library to emulate different Enigma machines models using MicroPython.

### Display

#### E-Paper

* [micropython-waveshare-epaper](https://github.com/mcauser/micropython-waveshare-epaper) ⭐ 395 | 🐛 22 | 🌐 Python | 📅 2021-09-01 - Drivers for various Waveshare ePaper modules.
...
* [Inkplate-micropython](https://github.com/SolderedElectronics/Inkplate-micropython) ⭐ 91 | 🐛 2 | 🌐 Python | 📅 2026-08-10 - MicroPython driver for Inkplate boards.
...
* [micropython-inkplate6](https://github.com/tve/micropython-inkplate6) ⭐ 21 | 🐛 1 | 🌐 Python | 📅 2021-04-11 - MicroPython driver for the Inkplate 6.
...
* [micropython-font-to-py](https://github.com/peterhinch/micropython-font-to-py) ⭐ 470 | 🐛 9 | 🌐 Python | 📅 2025-05-28 - A Python 3 utility to convert fonts to Python source capable of being frozen as bytecode.
* [writer](https://github.com/peterhinch/micropython-font-to-py/blob/master/writer/WRITER.md) ⭐ 470 | 🐛 9 | 🌐 Python | 📅 2025-05-28 - A simple way to render above Python fonts to displays whose driver is subclassed from `framebuf`.
...
* [framebuf2](https://github.com/peter-l5/framebuf2) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2023-05-30 - MicroPython FrameBuffer extension: larger and rotated font, triangles and circles.
* [micropython\_GT30L24T3Y\_big5\_font](https://github.com/alankrantas/micropython_GT30L24T3Y_big5_font) ⚠️ Archived - MicroPython driver for reading BIG-5 Chinese characters from GT30L24T3Y / ER3303-1 SPI module.
...
* [mp\_jpeg](https://github.com/cnadler86/mp_jpeg) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-05-14 - A very fast MicroPython JPEG encoder and decoder for the ESP32.
* [MicroPython\_UPLOT](https://github.com/jposada202020/MicroPython_UPLOT) ⚠️ Archived - MicroPython Small Graphics Framework.

#### GUI

* [micropython-nano-gui](https://github.com/peterhinch/micropython-nano-gui) ⭐ 663 | 🐛 3 | 🌐 Python | 📅 2026-06-13 - A tiny display-only GUI with a limited set of GUI objects (widgets) for displays whose display driver is subclassed from the `framebuf` class. With drivers for TFT, ePaper and OLED displays.
* [lvgl](https://github.com/lvgl/lv_binding_micropython) ⭐ 353 | 🐛 70 | 🌐 C | 📅 2026-08-24 - An object-oriented, component-based high-level GUI library with MicroPython binding.
...
* [python\_lcd](https://github.com/dhylands/python_lcd) ⭐ 331 | 🐛 17 | 🌐 Python | 📅 2023-02-17 - Driver for HD44780-compatible dot matrix LCDs.
...
* [micropython-i2c-lcd](https://github.com/brainelectronics/micropython-i2c-lcd) ⭐ 21 | 🐛 4 | 🌐 Python | 📅 2023-10-21 - MicroPython package to control HD44780 LCD displays 1602 and 2004 via I2C.
...
* [micropython\_i2c\_lcd](https://github.com/Thomascountz/micropython_i2c_lcd) ⭐ 8 | 🐛 2 | 🌐 Python | 📅 2024-06-21 - MicroPython library for interacting with HD44780-based LCD displays through a PCF8574 I/O expander. It offers a high-level API for LCD control, including text display, cursor manipulation, and backlight settings, while also providing lower-level access to the GPIO operations on the PCF8574.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,848 | 🐛 230 | 🌐 Python | 📅 2026-08-24 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [st7789\_mpy](https://github.com/russhughes/st7789_mpy) ⭐ 725 | 🐛 37 | 🌐 Python | 📅 2026-07-21 - Fast MicroPython driver for ST7789 display module written in C.
...
* [s3lcd](https://github.com/russhughes/s3lcd) ⭐ 110 | 🐛 11 | 🌐 Python | 📅 2024-03-20 - ESP\_LCD based MicroPython driver for ESP32-S3 Devices with ST7789 or compatible displays.
* [st7789py\_mpy](https://github.com/devbis/st7789py_mpy) ⭐ 97 | 🐛 5 | 🌐 Python | 📅 2019-12-27 - Slow MicroPython driver for 240x240 ST7789 display without CS pin from AliExpress, written in MicroPython.
...
* [gc9a01py](https://github.com/russhughes/gc9a01py) ⭐ 61 | 🐛 7 | 🌐 Python | 📅 2021-05-06 - GC9A01 Display driver in MicroPython.
...
* [micropython-ili934x](https://github.com/tuupola/micropython-ili934x) ⭐ 18 | 🐛 1 | 🌐 Python | 📅 2018-02-16 - SPI driver for ILI934X series based TFT / LCD displays.
...
* [wt32sc01py](https://github.com/russhughes/wt32sc01py) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2023-09-15 - WT32SC01 Plus MicroPython Display Driver.
...
* [micropython-wemos-led-matrix-shield](https://github.com/mattytrentini/micropython-wemos-led-matrix) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2025-05-22 - Driver for Wemos D1 Mini Matrix LED shield, using TM1640 chip.
...
* [micropython-tm1637](https://github.com/mcauser/micropython-tm1637) ⭐ 230 | 🐛 5 | 🌐 Python | 📅 2023-07-04 - Driver for TM1637 quad 7-segment LED modules.
* [micropython-tm1638](https://github.com/mcauser/micropython-tm1638) ⭐ 39 | 🐛 4 | 🌐 Python | 📅 2023-06-15 - Driver for TM1638 dual quad 7-segment LED modules with switches.
* [max7219\_8digit](https://github.com/pdwerryhouse/max7219_8digit) ⭐ 25 | 🐛 4 | 🌐 Python | 📅 2023-03-18 - Driver for MAX7219 8-digit 7-segment LED modules.
...
* [micropython-max7219](https://github.com/JulienBacquart/micropython-max7219) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2017-06-11 - Driver for MAX7219 8-digit 7-segment LED modules.
...
* [micropython-sevenseg](https://github.com/kritishmohapatra/micropython-sevenseg) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-01-25 - Lightweight MicroPython library for single-digit 7-segment displays (common anode & cathode) with ESP32, ESP8266 and RP2040 support.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,848 | 🐛 230 | 🌐 Python | 📅 2026-08-24 - Driver for SSD1306 128x64 OLED displays.
...
* [SH1107](https://github.com/peter-l5/SH1107) ⭐ 45 | 🐛 1 | 🌐 Python | 📅 2025-05-28 - Driver for SH1107 OLED displays (128x128 and 128x64 pixels).
...
* [micropython-ssd1322](https://github.com/rdagger/micropython-ssd1322) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2024-09-29 - MicroPython display driver for SSD1322 grayscale OLED.
...
* [sh1107-micropython](https://github.com/nemart69/sh1107-micropython) ⭐ 10 | 🐛 2 | 🌐 Python | 📅 2022-12-08 - MicroPython driver for SH1107-based OLED display (64x128).
...
* [ADS1256](https://github.com/robert-hh/ADS1256) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2025-08-22 - Driver for the ADS1256 24-bit low noise ADC, both as a generic MicroPython version and using the RP2040/RP2350 PIO.
...
* [micropython-mcp4725](https://github.com/wayoda/micropython-mcp4725) ⭐ 13 | 🐛 2 | 🌐 Python | 📅 2016-09-06 - Driver for the MCP4725 I2C DAC.
...
* [micropython-inputs](https://github.com/alanmitchell/micropython-inputs) ⭐ 33 | 🐛 1 | 🌐 Python | 📅 2015-04-20 - Classes to count pulses, debounce digital inputs, and calculate moving averages of analog inputs for a MicroPython board.
...
* [micropython-mcp23017](https://github.com/mcauser/micropython-mcp23017) ⭐ 92 | 🐛 5 | 🌐 Python | 📅 2024-02-05 - MicroPython driver for MCP23017 16-bit I/O Expander.
* [micropython-pcf8574](https://github.com/mcauser/micropython-pcf8574) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2024-02-11 - MicroPython driver for PCF8574 8-Bit I2C I/O Expander with Interrupt.
...
* [micropython-pcf8575](https://github.com/mcauser/micropython-pcf8575) ⭐ 24 | 🐛 1 | 🌐 Python | 📅 2024-02-11 - MicroPython driver for PCF8575 16-Bit I2C I/O Expander with Interrupt.
...
* [pico-rgbkeypad](https://github.com/martinohanlon/pico-rgbkeypad) ⭐ 72 | 🐛 1 | 🌐 Python | 📅 2022-01-09 - A Python class for controlling the Pimoroni RGB Keypad for Raspberry Pi Pico.
...
* [MicroPython-SimpleKeypad](https://github.com/PerfecXX/MicroPython-SimpleKeypad) ⭐ 9 | 🐛 2 | 🌐 Python | 📅 2025-06-03 - MicroPython library for interfacing with a keypad matrix.
...
* [tca9548a](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/tca9548a.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython driver for the TCA9548A I2C multiplexer.
...
* [micropython-xl9535-kxv5-relay](https://github.com/mcauser/micropython-xl9535-kxv5-relay) ⭐ 14 | 🐛 2 | 🌐 Python | 📅 2024-02-04 - A MicroPython library for jxl XL9535-KxV5 I2C relay boards.

#### Rotary Encoder

* [asynchronous encoder driver](https://github.com/peterhinch/micropython-async/blob/master/v3/primitives/encoder.py) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Interface an encoder to uasyncio code.
...
* [micropython-8encoder](https://github.com/HowManyOliversAreThere/micropython-8encoder) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Driver for the I2C [M5Stack 8-Encoder Unit](https://shop.m5stack.com/products/8-encoder-unit-stm32f030).
...
* [Signal\_Generators](https://github.com/Wei1234c/Signal_Generators) ⭐ 25 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2022-03-12 - Signal generators (AD9833, AD9834, AD9850, ADF4351) toolbox.
...
* [Sun and Moon](https://github.com/peterhinch/micropython-samples/blob/master/astronomy/README.md) ⭐ 531 | 🐛 13 | 🌐 Python | 📅 2026-08-26 - Determine Sun and Moon rise and set times, Moon phases.
* [micropython-ulab](https://github.com/v923z/micropython-ulab) ⭐ 499 | 🐛 50 | 🌐 C | 📅 2026-08-04 - A NumPy-like fast vector module for MicroPython.
...
* [uMath](https://github.com/albaEDA/uMath) ⭐ 20 | 🐛 0 | 🌐 Python | 📅 2017-02-27 - Computer Algebra for microcontrollers.
* [MicroPython\_Statistics](https://github.com/rcolistete/MicroPython_Statistics) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2018-10-26 - Statistics module for MicroPython.
* [umatrix](https://github.com/iyassou/umatrix) ⭐ 17 | 🐛 0 | 🌐 Python | 📅 2022-02-14 - A matrix library for the MicroPython language.
* [micropython-npyfile](https://github.com/jonnor/micropython-npyfile/) ⭐ 8 | 🐛 1 | 🌐 Python | 📅 2026-05-03 - Numpy .npy file support for MicroPython, supports read/write/streaming.
* [uumpy](https://github.com/nickovs/uumpy) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2024-08-29 - A subset of NumPy for MicroPython.
* [Micropython Perlin](https://github.com/sjaak31367/micropython_perlin) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2024-09-11 - A Perlin noise generator module.
...
* [MicroPython Motor Kit](https://github.com/cnadler86/MicroPython_Motor) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2026-05-30 - General motor control libraries.
...
* [micropython-servo](https://github.com/redoxcode/micropython-servo) ⭐ 24 | 🐛 0 | 🌐 Python | 📅 2025-11-16 - Library to control RC servos using direct PWM output in a tidy way.
...
* [micropython-upybbot](https://github.com/jeffmer/micropython-upybbot) ⭐ 93 | 🐛 0 | 🌐 Python | 📅 2015-05-14 - A4988 driver for bipolar stepper motors.
...
* [micropython-stepper](https://github.com/redoxcode/micropython-stepper) ⭐ 22 | 🐛 1 | 🌐 Python | 📅 2025-11-16 - Library to control common stepper drivers in a tidy way.
* [ticlib](https://github.com/jphalip/ticlib) ⭐ 21 | 🐛 4 | 🌐 Python | 📅 2026-03-30 - Driver for Pololu Tic stepper motor controllers.
...
* [micropython-stepper-motor](https://github.com/larsks/micropython-stepper-motor) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-01-14 - Drive a 28BYJ-48 motor attached to a ULN2003 driver.
* [micropython-rp2-smartStepper](https://github.com/bikeNomad/micropython-rp2-smartStepper) ⭐ 7 | 🐛 0 | 🌐 Python | 📅 2026-03-27 - RP2040/RP2350 library using PIO and DMA to control a stepper motor.
...
* [ADXL345\_spi\_micropython](https://github.com/AlekseyFedorovich/ADXL345_spi_micropython) ⭐ 22 | 🐛 3 | 🌐 Python | 📅 2024-08-19 - Library for interacting through the SPI protocol with an 'Analog Devices ADXL345' accelerometer from an MCU flashed with MicroPython.
...
* [pms5003\_micropython](https://github.com/kevinkk525/pms5003_micropython) ⭐ 26 | 🐛 4 | 🌐 Python | 📅 2021-11-06 - Driver for PMS5003 air quality sensor for MicroPython.
...
* [micropython-pms5003-minimal](https://github.com/miketeachman/micropython-pms5003-minimal) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2019-11-15 - Driver for P air quality sensor for MicroPython.
...
* [BME280](https://github.com/robert-hh/BME280) ⭐ 139 | 🐛 2 | 🌐 Python | 📅 2025-06-15 - MicroPython driver for the BME280 sensor, target platform Pycom devices.
* [micropython-bmp280](https://github.com/dafvid/micropython-bmp280) ⭐ 118 | 🐛 4 | 🌐 Python | 📅 2023-11-18 - Module for the BMP280 sensor.
...
* [MicroPython-BMPxxx](https://github.com/bradcar/MicroPython_BMPxxx) ⭐ 8 | 🐛 0 | 🌐 Python | 📅 2026-08-06 - Driver for BMP585, BMP581, BMP390, BMP280 Bosch temperature/pressure sensors.
...
* [BMP390](https://github.com/octaprog7/BMP390) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-05-22 - MicroPython module for BMP390 pressure & temperature sensor.
* [BMP180](https://github.com/octaprog7/BMP180) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-05-10 - MicroPython module for BMP180 pressure & temperature sensor.
...
* [bmp581](https://github.com/octaprog7/bmp581) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-05-14 - MicroPython module for BMP581, pressure and ambient temperature sensor from Bosch Sensortec.
...
* [MAX30102-MicroPython-driver](https://github.com/n-elia/MAX30102-MicroPython-driver) ⭐ 85 | 🐛 0 | 🌐 Python | 📅 2026-05-18 - A MAX30102 driver ported to MicroPython. It should also work for MAX30105.
...
* [max30102](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/max30102.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython driver for the MAX30102, with heartbeat detection and BPM measurement.

#### Camera

* [micropython-camera-driver](https://github.com/lemariva/micropython-camera-driver) ⭐ 565 | 🐛 34 | 🌐 C | 📅 2023-10-22 - OV2640 camera driver for MicroPython on ESP32.
* [uPyCam](https://github.com/lemariva/uPyCam) ⭐ 168 | 🐛 11 | 🌐 Python | 📅 2022-02-02 - Take a photo with an ESP32-CAM running MicroPython.
* [micropython-camera-API](https://github.com/cnadler86/micropython-camera-API) ⭐ 162 | 🐛 2 | 🌐 C | 📅 2026-01-12 - Project with the aim of supporting cameras across various ports in MicroPython, starting with the ESP32 port and Omnivision cameras (OV2640 & OV5640).
...
* [IoTy huskylib](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/huskylib.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython driver for the DFRobot Husky Lens. An easy-to-use AI Camera / Vision Sensor, featuring face recognition, object tracking, object recognition, line tracking, color recognition, and QR code recognition.
* [IoTy mv](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/mv.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - A simple machine vision library that provides blob and circle detection.
...
* [veml6040](https://github.com/octaprog7/veml6040) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-04-16 - MicroPython module for managing a color sensor RGBW, VEML6040 from Vishay.
...
* [micropython-esp8266-hmc5883l](https://github.com/gvalkov/micropython-esp8266-hmc5883l) ⭐ 17 | 🐛 2 | 🌐 Python | 📅 2024-09-07 - 3-axis digital compass on the ESP8266.
* [QMC5883](https://github.com/robert-hh/QMC5883) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2025-05-21 - Python class for the QMC5883 Three-Axis Digital Compass IC.
...
* [QMC5883](https://github.com/octaprog7/QMC5883) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-06-12 - MicroPython module for control QMC5883L geomagnetic sensor.

#### Current

* [pyb\_ina219](https://github.com/chrisb2/pyb_ina219) ⭐ 63 | 🐛 3 | 🌐 Python | 📅 2023-08-05 - Driver for INA219 current sensor.
* [TI\_INA226\_micropython](https://github.com/elschopi/TI_INA226_micropython) ⭐ 40 | 🐛 0 | 🌐 Python | 📅 2026-07-20 - MicroPython driver for Texas Instruments INA226 power measuring IC.
...
* [vl53l5cx](https://github.com/mp-extras/vl53l5cx) ⭐ 26 | 🐛 8 | 🌐 Python | 📅 2024-05-10 - MicroPython and CircuitPython Package for the [VL53L5CX](https://www.st.com/en/imaging-and-photonics-solutions/vl53l5cx.html) (4x4/8x8 ToF sensor array).
* [vl53l1x](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vl53l1x.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython driver for the VL53L1X ToF sensor.
* [IoTy lds02rr](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/lds02rr.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - Driver for the LDS02RR 360 degree LiDAR.
* [IoTy coind4](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/coind4.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - Driver for the COIN-D4 360 degree LiDAR.
* [IoTy delta2d](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/delta2d.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - Driver for the Delta-2D 360 degree LiDAR.
...
* [micropython-p1meter](https://github.com/Josverl/micropython-p1meter) ⭐ 34 | 🐛 1 | 🌐 Python | 📅 2026-05-23 - A ESP32 sensor to read a p1 electricity meter and publish this to MQTT and Home Assistant, written in MicroPython.
...
* [CCS811](https://github.com/Notthemarsian/CCS811) ⭐ 33 | 🐛 4 | 🌐 Python | 📅 2020-11-02 - Basic MicroPython driver for CCS811 on ESP8266 boards.
...
* [ld2410](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/ld2410.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - 24GHz human presence sensing module, capable of detecting moving and stationary targets, and providing an approximate range.
...
* [bh1750](https://github.com/PinkInk/upylib/tree/master/bh1750) ⭐ 57 | 🐛 0 | 🌐 Python | 📅 2018-06-12 - BH1750 I2C digital light sensor driver.
...
* [veml7700](https://github.com/palouf34/veml7700) ⭐ 19 | 🐛 0 | 🌐 Python | 📅 2019-12-21 - Library for MicroPython for VEML7700 light sensor.
...
* [veml7700](https://github.com/octaprog7/veml7700) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-04-16 - MicroPython module for the VEML7700 ambient light sensor (ALS) from Vishay.
* [bh1750.py](https://github.com/adyavanapalli/bh1750.py) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2025-08-10 - MicroPython BH1750 ambient light sensor driver.
* [opt3001](https://github.com/octaprog7/opt3001) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-04-20 - MicroPython module for OPT3001, external lighting sensor from Texas Instruments.
* [ltr390uv](https://github.com/octaprog7/ltr390uv) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-04-21 - MicroPython module for LTR390UV, ambient light sensor in the visible and ultraviolet ranges.
...
* [hx710](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/hx710.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython driver for the HX710.
...
* [RM3100](https://github.com/octaprog7/RM3100) ⭐ 3 | 🐛 1 | 🌐 Python | 📅 2026-06-12 - MicroPython module for RM3100 geomagnetic sensor.
...
* [HSCDTD008A](https://github.com/octaprog7/HSCDTD008A) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-06-12 - MicroPython module for HSCDTD008A geomagnetic sensor.
...
* [MPU6050-ESP32-MicroPython](https://github.com/gitcnd/MPU6050-ESP32-MicroPython) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2024-07-30 - MPU6050 (Accelerometer/Gyroscope) driver which works on ESP32.
...
* [apds9960](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/apds9960.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-28 - MicroPython Driver for the APDS9960, with simple gesture detection.
...
* [AS726X\_LoPy](https://github.com/jajberni/AS726X_LoPy) ⭐ 11 | 🐛 1 | 🌐 Python | 📅 2018-03-27 - MicroPython driver for the AS726X spectral sensor.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,848 | 🐛 230 | 🌐 Python | 📅 2026-08-24 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
* [HTU21D](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/HTU21D.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - Asynchronous driver for HTU21D temperature and humidity sensor.
...
* [LM75-MicroPython](https://github.com/OldhamMade/LM75-MicroPython) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2025-07-24 - Driver for LM75 digital temperature sensor, I2C interface.
...
* [micropython-sht11](https://github.com/2black0/micropython-sht11) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2025-05-02 - Driver for Sensirion SHT11 temperature and humidity sensor.
...
* [TMP117](https://github.com/octaprog7/TMP117) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-04-04 - MicroPython module for the TMP117 temperature sensor from Texas Instruments.
...
* [micropython-zacwire](https://github.com/mdaeron/micropython-zacwire) ⭐ 0 | 🐛 1 | 🌐 Python | 📅 2024-11-01 - MicroPython driver for the ZACwire protocol used in TSic 506F temperature sensors.
...
* [SHT4X](https://github.com/octaprog7/SHT4X) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2026-04-29 - MicroPython module for controlling the SHT4x - 4th generation relative humidity and temperature sensor.
...
* [micropython-mlx90614](https://github.com/mcauser/micropython-mlx90614) ⭐ 38 | 🐛 5 | 🌐 Python | 📅 2024-04-16 - Driver for Melexis MLX90614 IR temperature sensor.
...
* [micropython-TTP229-BSF](https://github.com/alankrantas/micropython-TTP229-BSF) ⚠️ Archived - MicroPython ESP8266/ESP32 driver for TTP229-BSF 16-key capacitive keypad in serial interface mode.
* [uFT6336U](https://github.com/fantasticdonkey/uFT6336U) ⭐ 10 | 🐛 0 | 🌐 Python | 📅 2021-02-21 - MicroPython I2C driver for the Focus LCDs FT6336U capacitive touch panel controller IC.
...
* [Schedule](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/SCHEDULE.md) ⭐ 829 | 🐛 4 | 🌐 Python | 📅 2026-08-26 - A scheduler for asyncio based applications. Schedule events at specified times and dates or with reference to Sun and Moon rise and set.
...
* [Suntime](https://github.com/lorcap/micropython-suntime) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2026-01-07 - Approximated calculation of sunrise and sunset time. Given a `date` and the coordinate pair `(latitude, longitude)` of a place on Earth, this library computes when sun rises above the horizon and when it sets down on that day in that place.

### Storage

#### Configuration file

* [toml](https://github.com/gitcnd/toml) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2024-08-09 - Read and write .toml files. Works in MicroPython and CircuitPython.
...
* [uSQLite](https://github.com/spatialdude/usqlite) ⭐ 127 | 🐛 26 | 🌐 C | 📅 2024-11-01 - SQLite library module for MicroPython.
* [micropg](https://github.com/nakagami/micropg) ⭐ 27 | 🐛 0 | 🌐 Python | 📅 2026-05-02 - PostgreSQL database driver for MicroPython.
* [micropython-firebase-realtime-database](https://github.com/ckoever/micropython-firebase-realtime-database) ⭐ 26 | 🐛 3 | 🌐 Python | 📅 2024-08-06 - Firebase implementation for MicroPython optimized for ESP32.
* [uPyMySQL](https://github.com/dvrhax/uPyMySQL) ⭐ 25 | 🐛 5 | 🌐 Python | 📅 2020-05-07 - Pure MicroPython MySQL Client.
...
* [nmongo](https://github.com/nakagami/nmongo) ⭐ 20 | 🐛 1 | 🌐 Python | 📅 2026-05-02 - MongoDB client for CPython and MicroPython, with MongoDB shell-like APIs.
...
* [micropython\_eeprom](https://github.com/peterhinch/micropython_eeprom) ⭐ 85 | 🐛 7 | 🌐 Python | 📅 2024-09-29 - Cross-platform MicroPython device drivers for memory chips (EEPROM, FRAM, Flash, PSRAM).
* [micropython-eeprom](https://github.com/brainelectronics/micropython-eeprom) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2023-06-12 - MicroPython driver for AT24Cxx EEPROM.
...
* [micropython\_data\_to\_py](https://github.com/peterhinch/micropython_data_to_py) ⭐ 34 | 🐛 0 | 🌐 Python | 📅 2023-08-01 - A Python 3 utility to convert an arbitrary binary file to Python source for freezing as bytecode in Flash.
* [freezeFS](https://github.com/bixb922/freezeFS) ⭐ 33 | 🐛 1 | 🌐 Python | 📅 2025-10-25 - Create self-extracting compressed or self-mounting archives for MicroPython.
* [micropython-winbond](https://github.com/brainelectronics/micropython-winbond) ⭐ 19 | 🐛 1 | 🌐 Python | 📅 2024-05-30 - Interact with Winbond W25Q Flash chips via SPI.
...
* [mp-sdcard-littleFS](https://github.com/jornamon/mp-sdcard-littleFS) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2024-02-21 - MicroPython SD card driver that works with LittleFS2 (implements extended interface).
...
* [upymenu](https://github.com/jplattel/upymenu) ⭐ 34 | 🐛 6 | 🌐 Python | 📅 2026-05-14 - MicroPython Menu for LCD Displays.
...
* [mp\_wcwidth](https://github.com/Josverl/mp_wcwidth) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - Python port of [wcwidth](https://github.com/jquast/wcwidth) ⭐ 466 | 🐛 1 | 🌐 Python | 📅 2026-08-28 to handle wide unicode characters such as "你好世界" in terminal output.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,047 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [micrOS](https://github.com/BxNxM/micrOS) ⭐ 137 | 🐛 0 | 🌐 Python | 📅 2026-08-29 - MicroPython-based IoT Framework.
...
* [MicroPython on GitHub](https://github.com/micropython/micropython) ⭐ 22,025 | 🐛 1,536 | 🌐 C | 📅 2026-08-28 - Submit bug reports, follow and join in development on GitHub.
* [MicroPython Wiki](https://github.com/micropython/micropython/wiki) ⭐ 22,025 | 🐛 1,536 | 🌐 C | 📅 2026-08-28 - Community generated documentation and examples of the features of MicroPython and the Pyboard.
...
* [micropy-cli](https://github.com/BradenM/micropy-cli) ⭐ 337 | 🐛 53 | 🌐 Python | 📅 2026-08-29 - Micropy CLI is a project management/generation tool for writing MicroPython code in modern IDEs such as Visual Studio Code.
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 317 | 🐛 24 | 🌐 Python | 📅 2026-08-30 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
* [micropython-stubber](https://github.com/Josverl/micropython-stubber) ⭐ 255 | 🐛 8 | 🌐 Python | 📅 2026-08-30 - Generate and use stubs for different MicroPython firmwares to use with Visual Studio Code or any IDE and linter.
...
* [micropython-aiosentry](https://github.com/devbis/micropython-aiosentry) ⭐ 11 | 🐛 0 | 🌐 Python | 📅 2019-03-12 - Asynchronous Sentry.io micro client for MicroPython.

### Firmware

* [micropython-builder](https://github.com/jonahbron/micropython-builder) ⭐ 1 | 🐛 0 | 🌐 Nix | 📅 2024-04-29 - Tool for building and flashing a custom MicroPython firmware.
...
* [micropython-magic](https://github.com/josverl/micropython-magic) ⭐ 31 | 🐛 10 | 🌐 Python | 📅 2026-07-21 - MicroPython integrated into Jupyter notebooks.
...
* [Micropython-Editor](https://github.com/robert-hh/Micropython-Editor) ⭐ 254 | 🐛 3 | 🌐 Python | 📅 2026-07-19 - Small on-board editor for Pyboard, WiPy, ESP8266, ESP32, PyCom and Adafruit devices written in Python.
* [upy-shell](https://github.com/dhylands/upy-shell) ⭐ 42 | 🐛 9 | 🌐 Python | 📅 2018-03-23 - A simple command line-based shell for MicroPython.
* [mpy\_shell](https://github.com/gitcnd/mpy_shell) ⭐ 6 | 🐛 0 | 🌐 Python | 📅 2024-08-17 - Linux-like shell for MicroPython. Full featured, very lightweight.

#### On Host

* [mpremote](https://github.com/micropython/micropython/blob/master/tools/mpremote/README.md) ⭐ 22,025 | 🐛 1,536 | 🌐 C | 📅 2026-08-28 - Powerful official shell that supports mounting the host's current directory on the target. Run code without changing the target's filesystem.
...
* [belay](https://github.com/BrianPugh/belay) ⭐ 273 | 🐛 2 | 🌐 Python | 📅 2026-03-03 - Belay is a Python library that enables the rapid development of projects that interact with hardware via a MicroPython-compatible board.
...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines](https://github.com/mcauser/awesome-micropython/blob/master/contributing.md) ⭐ 1,803 | 🐛 9 | 🌐 HTML | 📅 2026-07-20 first.
