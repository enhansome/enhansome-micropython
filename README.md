...
* [ucryptography](https://github.com/dmazzella/ucryptography) ⭐ 11 | 🐛 0 | 🌐 C | 📅 2026-08-06 - Lightweight porting of pyca/cryptography to MicroPython based on ARM Mbed TLS.
...
* [micropyGPS](https://github.com/inmcm/micropyGPS) ⭐ 388 | 🐛 15 | 🌐 Python | 📅 2023-02-18 - Full featured GPS NMEA sentence parser.
...
* [micropython\_ir](https://github.com/peterhinch/micropython_ir) ⭐ 309 | 🐛 13 | 🌐 Python | 📅 2026-04-27 - Nonblocking device drivers to receive from IR remotes and for IR "blaster" apps.
...
* [micropython-mdns](https://github.com/cbrand/micropython-mdns) ⭐ 85 | 🐛 0 | 🌐 Python | 📅 2025-12-29 - A pure Python implementation of MDNS with support for Service Discovery.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 687 | 🐛 22 | 🌐 Python | 📅 2026-03-14 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,842 | 🐛 229 | 🌐 Python | 📅 2026-08-10 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,842 | 🐛 229 | 🌐 Python | 📅 2026-08-10 - Official driver for nRF24L01 2.4GHz radio modules.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,842 | 🐛 229 | 🌐 Python | 📅 2026-08-10 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [gc9a01\_mpy](https://github.com/russhughes/gc9a01_mpy) ⭐ 211 | 🐛 24 | 🌐 Python | 📅 2025-03-24 - Fast MicroPython driver for GC9A01 display modules written in C.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,842 | 🐛 229 | 🌐 Python | 📅 2026-08-10 - Driver for SSD1306 128x64 OLED displays.
...
* [micropython-camera-driver](https://github.com/lemariva/micropython-camera-driver) ⭐ 564 | 🐛 34 | 🌐 C | 📅 2023-10-22 - OV2640 camera driver for MicroPython on ESP32.
...
* [VL53L0X](https://github.com/uceeatz/VL53L0X) ⭐ 53 | 🐛 9 | 🌐 Python | 📅 2022-04-24 - MicroPython Library for LiDAR Sensor VL53L0X.
...
* [hx711](https://github.com/robert-hh/hx711) ⭐ 69 | 🐛 2 | 🌐 Python | 📅 2025-09-09 - MicroPython driver for the HX711 load cell interface.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,842 | 🐛 229 | 🌐 Python | 📅 2026-08-10 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
...
* [mp\_wcwidth](https://github.com/Josverl/mp_wcwidth) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - Python port of [wcwidth](https://github.com/jquast/wcwidth) ⭐ 463 | 🐛 1 | 🌐 Python | 📅 2026-08-07 to handle wide unicode characters such as "你好世界" in terminal output.
...
* [micrOS](https://github.com/BxNxM/micrOS) ⭐ 137 | 🐛 0 | 🌐 Python | 📅 2026-08-11 - MicroPython-based IoT Framework.
...
* [micropy-cli](https://github.com/BradenM/micropy-cli) ⭐ 337 | 🐛 54 | 🌐 Python | 📅 2026-08-10 - Micropy CLI is a project management/generation tool for writing MicroPython code in modern IDEs such as Visual Studio Code.
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 314 | 🐛 23 | 🌐 Python | 📅 2026-08-12 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines](https://github.com/mcauser/awesome-micropython/blob/master/contributing.md) ⭐ 1,801 | 🐛 8 | 🌐 HTML | 📅 2026-07-20 first.
