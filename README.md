...
* [emlearn-micropython](https://github.com/emlearn/emlearn-micropython) ⭐ 163 | 🐛 11 | 🌐 C | 📅 2026-07-30 - Efficient Machine Learning engine for MicroPython.
...
* [yx5300](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/yx5300.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MP3 player that can be controlled via a serial interface.
* [IoTy vs1003](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vs1003.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - Driver for the VS1003 MP3 decoder / encoder. Supports playing of MP3, WMA, MIDI, ADPCM, and recording of ADPCM.
...
* [BTHome-MicroPython](https://github.com/DavesCodeMusings/BTHome-MicroPython) ⭐ 21 | 🐛 6 | 🌐 Python | 📅 2026-07-30 - MicroPython module to format sensor readings for BTHome BLE advertising payloads.
...
* [Asynchronous GPS driver](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/GPS.md) ⭐ 828 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Receive and parse GPS data as a uasyncio task.
...
* [microhomie](https://github.com/microhomie/microhomie) ⭐ 82 | 🐛 3 | 🌐 Python | 📅 2021-01-18 - MicroPython implementation of the Homie MQTT convention for IoT.
...
* [micropython\_ir](https://github.com/peterhinch/micropython_ir) ⭐ 310 | 🐛 13 | 🌐 Python | 📅 2026-04-27 - Nonblocking device drivers to receive from IR remotes and for IR "blaster" apps.
...
* [micropython-mdns](https://github.com/cbrand/micropython-mdns) ⭐ 85 | 🐛 1 | 🌐 Python | 📅 2025-12-29 - A pure Python implementation of MDNS with support for Service Discovery.
...
* [micropython-mqtt](https://github.com/peterhinch/micropython-mqtt) ⭐ 687 | 🐛 23 | 🌐 Python | 📅 2026-03-14 - A 'resilient' asynchronous MQTT client: recovers from WiFi and broker outages.
...
* [pysmartnode](https://github.com/kevinkk525/pysmartnode) ⭐ 117 | 🐛 2 | 🌐 Python | 📅 2021-05-31 -  MicroPython Smart Home framework.
...
* [Official OneWire](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/bus/onewire) ⭐ 2,840 | 🐛 230 | 🌐 Python | 📅 2026-08-10 - For devices using the OneWire bus, eg Dallas DS18x20.
...
* [Official nRF24L01](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/radio/nrf24l01) ⭐ 2,840 | 🐛 230 | 🌐 Python | 📅 2026-08-10 - Official driver for nRF24L01 2.4GHz radio modules.
...
* [micropython-mfrc522](https://github.com/wendlers/micropython-mfrc522) ⭐ 189 | 🐛 21 | 🌐 Python | 📅 2024-01-18 - Driver for NXP MFRC522 RFID reader/writer.
...
* [I2C Slave](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/I2C.md) ⭐ 828 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Uses the Pyboard's I2C slave mode to implement a full duplex asynchronous link. Principal use case is for ESP8266 which has only one UART.
...
* [microdot](https://github.com/miguelgrinberg/microdot) ⭐ 2,138 | 🐛 7 | 🌐 Python | 📅 2026-08-09 - The impossibly small web framework for MicroPython.
...
* [microCoAPy](https://github.com/insighio/microCoAPy) ⭐ 69 | 🐛 5 | 🌐 Python | 📅 2025-06-20 - A mini client/server implementation of CoAP (Constrained Application Protocol) into MicroPython.
...
* [micropython-font-to-py](https://github.com/peterhinch/micropython-font-to-py) ⭐ 468 | 🐛 9 | 🌐 Python | 📅 2025-05-28 - A Python 3 utility to convert fonts to Python source capable of being frozen as bytecode.
* [writer](https://github.com/peterhinch/micropython-font-to-py/blob/master/writer/WRITER.md) ⭐ 468 | 🐛 9 | 🌐 Python | 📅 2025-05-28 - A simple way to render above Python fonts to displays whose driver is subclassed from `framebuf`.
...
* [mp\_jpeg](https://github.com/cnadler86/mp_jpeg) ⭐ 10 | 🐛 0 | 🌐 C | 📅 2026-05-14 - A very fast MicroPython JPEG encoder and decoder for the ESP32.
...
* [micro-gui](https://github.com/peterhinch/micropython-micro-gui) ⭐ 350 | 🐛 12 | 🌐 Python | 📅 2026-06-25 - Derived from nano-gui and supporting the same displays and hosts, this provides for user input via push buttons or a navigation joystick and an optional rotary encoder.
...
* [Official LCD160CR](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/lcd160cr) ⭐ 2,840 | 🐛 230 | 🌐 Python | 📅 2026-08-10 - Driver for official MicroPython LCD160CR display with resistive touch sensor.
...
* [s3lcd](https://github.com/russhughes/s3lcd) ⭐ 111 | 🐛 11 | 🌐 Python | 📅 2024-03-20 - ESP\_LCD based MicroPython driver for ESP32-S3 Devices with ST7789 or compatible displays.
...
* [ST77xx-pure-MP](https://github.com/antirez/ST77xx-pure-MP) ⭐ 54 | 🐛 4 | 🌐 Python | 📅 2025-03-25 - Pure MicroPython driver for ST77xx displays. Low memory requirements.
...
* [Official SSD1306](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/display/ssd1306) ⭐ 2,840 | 🐛 230 | 🌐 Python | 📅 2026-08-10 - Driver for SSD1306 128x64 OLED displays.
...
* [tca9548a](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/tca9548a.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython driver for the TCA9548A I2C multiplexer.
...
* [asynchronous encoder driver](https://github.com/peterhinch/micropython-async/blob/master/v3/primitives/encoder.py) ⭐ 828 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Interface an encoder to uasyncio code.
...
* [ulinalg](https://github.com/jalawson/ulinalg) ⭐ 31 | 🐛 2 | 🌐 Python | 📅 2019-03-22 - Small size matrix handling module with a few linear algebra operations specifically for MicroPython (Python 3).
...
* [micropython-bmp280](https://github.com/dafvid/micropython-bmp280) ⭐ 117 | 🐛 4 | 🌐 Python | 📅 2023-11-18 - Module for the BMP280 sensor.
...
* [max30102](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/max30102.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython driver for the MAX30102, with heartbeat detection and BPM measurement.
...
* [micropython-camera-API](https://github.com/cnadler86/micropython-camera-API) ⭐ 160 | 🐛 2 | 🌐 C | 📅 2026-01-12 - Project with the aim of supporting cameras across various ports in MicroPython, starting with the ESP32 port and Omnivision cameras (OV2640 & OV5640).
...
* [IoTy huskylib](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/huskylib.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython driver for the DFRobot Husky Lens. An easy-to-use AI Camera / Vision Sensor, featuring face recognition, object tracking, object recognition, line tracking, color recognition, and QR code recognition.
* [IoTy mv](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/mv.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - A simple machine vision library that provides blob and circle detection.
...
* [vl53l1x\_pico](https://github.com/drakxtwo/vl53l1x_pico) ⭐ 30 | 🐛 1 | 🌐 Python | 📅 2021-04-08 - MicroPython driver for the VL53L1X ToF sensor.
* [vl53l5cx](https://github.com/mp-extras/vl53l5cx) ⭐ 25 | 🐛 8 | 🌐 Python | 📅 2024-05-10 - MicroPython and CircuitPython Package for the [VL53L5CX](https://www.st.com/en/imaging-and-photonics-solutions/vl53l5cx.html) (4x4/8x8 ToF sensor array).
* [vl53l1x](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/vl53l1x.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython driver for the VL53L1X ToF sensor.
* [IoTy lds02rr](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/lds02rr.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - Driver for the LDS02RR 360 degree LiDAR.
* [IoTy coind4](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/coind4.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - Driver for the COIN-D4 360 degree LiDAR.
* [IoTy delta2d](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/delta2d.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - Driver for the Delta-2D 360 degree LiDAR.
...
* [micropython-hcsr04](https://github.com/rsc1975/micropython-hcsr04) ⭐ 169 | 🐛 2 | 🌐 Python | 📅 2023-03-08 - Driver for HC-SR04 ultrasonic distance sensors.
...
* [ld2410](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/ld2410.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - 24GHz human presence sensing module, capable of detecting moving and stationary targets, and providing an approximate range.
...
* [hx710](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/hx710.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython driver for the HX710.
...
* [apds9960](https://github.com/QuirkyCort/IoTy/blob/main/public/extensions/apds9960.py) ⭐ 17 | 🐛 3 | 🌐 JavaScript | 📅 2026-08-04 - MicroPython Driver for the APDS9960, with simple gesture detection.
...
* [Official DHT11+DHT12](https://github.com/micropython/micropython-lib/tree/master/micropython/drivers/sensor/dht) ⭐ 2,840 | 🐛 230 | 🌐 Python | 📅 2026-08-10 - ESP8266 driver for DHT11 and DHT12 temperature and humidity sensor.
* [HTU21D](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/HTU21D.md) ⭐ 828 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - Asynchronous driver for HTU21D temperature and humidity sensor.
...
* [micropython\_ahtx0](https://github.com/targetblank/micropython_ahtx0) ⭐ 52 | 🐛 0 | 🌐 Python | 📅 2023-10-12 - MicroPython driver for the AHT10 and AHT20 temperature and humidity sensors.
...
* [Schedule](https://github.com/peterhinch/micropython-async/blob/master/v3/docs/SCHEDULE.md) ⭐ 828 | 🐛 4 | 🌐 Python | 📅 2026-07-14 - A scheduler for asyncio based applications. Schedule events at specified times and dates or with reference to Sun and Moon rise and set.
...
* [micropg](https://github.com/nakagami/micropg) ⭐ 27 | 🐛 1 | 🌐 Python | 📅 2026-05-02 - PostgreSQL database driver for MicroPython.
...
* [mp\_wcwidth](https://github.com/Josverl/mp_wcwidth) ⭐ 3 | 🐛 0 | 🌐 Python | 📅 2026-01-27 - Python port of [wcwidth](https://github.com/jquast/wcwidth) ⭐ 465 | 🐛 1 | 🌐 Python | 📅 2026-08-07 to handle wide unicode characters such as "你好世界" in terminal output.
...
* [100 Days 100 IoT Projects](https://github.com/kritishmohapatra/100_Days_100_IoT_Projects) ⭐ 1,007 | 🐛 0 | 🌐 Python | 📅 2026-07-17 - A 100-day challenge building real-world IoT projects with MicroPython on ESP32, ESP8266 and Raspberry Pi Pico 2W. Step-by-step documented with wiring diagrams and code for beginners.
...
* [MicroPython on GitHub](https://github.com/micropython/micropython) ⭐ 21,991 | 🐛 1,537 | 🌐 C | 📅 2026-08-16 - Submit bug reports, follow and join in development on GitHub.
* [MicroPython Wiki](https://github.com/micropython/micropython/wiki) ⭐ 21,991 | 🐛 1,537 | 🌐 C | 📅 2026-08-16 - Community generated documentation and examples of the features of MicroPython and the Pyboard.
...
* [micropython-stubs](https://github.com/Josverl/micropython-stubs) ⭐ 316 | 🐛 23 | 🌐 Python | 📅 2026-08-16 - Stubs of most MicroPython ports, boards and versions to make writing code that much simpler.
...
* [Asynchronous monitor](https://github.com/peterhinch/micropython-monitor) ⭐ 40 | 🐛 0 | 🌐 Python | 📅 2025-11-03 - Use a Raspberry Pico and a logic analyser or scope to monitor asynchronous code.
...
* [mpremote](https://github.com/micropython/micropython/blob/master/tools/mpremote/README.md) ⭐ 21,991 | 🐛 1,537 | 🌐 C | 📅 2026-08-16 - Powerful official shell that supports mounting the host's current directory on the target. Run code without changing the target's filesystem.
...
Contributions and suggestions are always welcome! Please take a look at the [contribution guidelines](https://github.com/mcauser/awesome-micropython/blob/master/contributing.md) ⭐ 1,801 | 🐛 9 | 🌐 HTML | 📅 2026-07-20 first.
